...
<head>
    ...
    <link href="<?php echo base_url() ?>/assets/css/sweetAlert.css" id="theme" rel="stylesheet">
    ...
    <link href="<?php echo base_url() ?>/assets/plugins/bower_components/bootstrap-datetimepicker-master/css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0 sidebar">
            <div class="navbar-header"> 
                <div class="top-left-part"><a class="logo" href="index.php"><b><img src="<?php echo base_url() ?>/assets/plugins/images/imperialsofetch.png" alt="home" /></b><span class="hidden-xs"> Imperial Softech</span></a></div>
          </div>
        </nav>
        <!-- Left navbar-header -->
